...
- [x] Add a custom Open Graph preview image for GitHub.
- [x] Add GitHub Actions for automated typecheck and production build.
- [x] Add screenshots/demo guidance and CI status to the README.
